export const translations = {
  ...
  ar: {
    ...
    permissions: {
      ...
      descriptionEn: "الوصف (إنجليزي)",
      descriptionAr: "الوصف (عربي)",
      systemPermission: "صلاحية نظام",
      customPermission: "صلاحية مخصصة",
      noPermissions: "لا توجد صلاحيات",
      confirmDelete: "هل أنت متأكد من حذف هذه الصلاحية؟",
      ...
      cannotDeleteSystem: "لا يمكن حذف صلاحيات النظام",
      searchPermissions: "البحث عن صلاحيات...",
      categories: {
        page: "صفحة",
        api: "واجهة برمجية",
        button: "زر",
